...
Describe "Get-EntraBetaObjectSetting" {
    Context "Test for Get-EntraBetaObjectSetting" {
        It "Should return specific Object Setting" {
            $result = Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc"
        ...
        It "Should fail when Top is empty" {
            { Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -Top } | Should -Throw "Missing an argument for parameter 'Top'*"
        }
        It "Should fail when Top is invalid" {
            { Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -Top XY } | Should -Throw "Cannot process argument transformation on parameter 'Top'*"
        }
        It "Should return all Object Setting" {
            $result = Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -All 
            $result | Should -Not -BeNullOrEmpty            

            Should -Invoke -CommandName Invoke-GraphRequest -ModuleName Microsoft.Entra.Beta.Groups -Times 1
        }
        It "Should fail when All has an argument" {
            { Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -All $true } | Should -Throw "A positional parameter cannot be found that accepts argument 'True'.*"
        }           

        It "Should return top Object Setting" {
            $result = @(Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -Top 1)
            $result | Should -Not -BeNullOrEmpty
        ...
        It "Should contain property when passed property to it" {
            $result = Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -Property DisplayName
        ...
        It "Should execute successfully without throwing an error " {
            ...
            try {
                ...
                { Get-EntraBetaObjectSetting -TargetType "Groups" -TargetObjectId "aaaaaaaa-1111-2222-3333-cccccccccccc" -Property DisplayName -Debug } | Should -Not -Throw
            }
            finally {
