...
BeforeAll {  
    ...
    Mock -CommandName Update-MgBetaDevice -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
}
...
Describe "Set-EntraBetaDevice"{
    Context "Test for Set-EntraBetaDevice" {
        It "Should return empty object"{
            ...
            Should -Invoke -CommandName Update-MgBetaDevice -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain DeviceId in parameters when passed DeviceObjectId to it" {
            Mock -CommandName Update-MgBetaDevice -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Update-MgBetaDevice -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
