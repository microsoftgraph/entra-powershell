...
Describe "Set-EntraBetaCustomSecurityAttributeDefinition" {
    Context "Test for Set-EntraBetaCustomSecurityAttributeDefinition" {
        It "Should update custom security attribute definition" {
            ...
            Should -Invoke -CommandName Update-MgBetaDirectoryCustomSecurityAttributeDefinition -ModuleName Microsoft.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain CustomSecurityAttributeDefinitionId in parameters when passed Id to it" {
            Mock -CommandName Update-MgBetaDirectoryCustomSecurityAttributeDefinition -MockWith {$args} -ModuleName Microsoft.Entra.Beta.DirectoryManagement
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Set-EntraBetaCustomSecurityAttributeDefinition"
            Should -Invoke -CommandName Update-MgBetaDirectoryCustomSecurityAttributeDefinition -ModuleName Microsoft.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
