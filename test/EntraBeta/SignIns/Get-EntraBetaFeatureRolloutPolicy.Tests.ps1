...
Describe "Get-EntraBetaFeatureRolloutPolicy" {
    Context "Test for Get-EntraBetaFeatureRolloutPolicy" {
        It "Should throw when not connected and not invoke SDK" {
            ...
            { Get-EntraBetaFeatureRolloutPolicy -Id "bbbbbbbb-1111-2222-3333-cccccccccc55" } | Should -Throw "Not connected to Microsoft Graph*"
            Should -Invoke -CommandName Get-MgBetaPolicyFeatureRolloutPolicy -ModuleName Microsoft.Entra.Beta.SignIns -Times 0
        }
