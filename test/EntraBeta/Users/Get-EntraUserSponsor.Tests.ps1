...
Describe "Get-EntraUserSponsor" {
    Context "Test for Get-EntraUserSponsor" {
        ...
        It "Should fail when top is empty" {
            { Get-EntraUserOwnedObject -UserId "00aa00aa-bb11-cc22-dd33-44ee44ee44e" -Top } | Should -Throw "Missing an argument for parameter 'Top'*"
        }  
        It "Should fail when top is invalid" {
            { Get-EntraUserOwnedObject -UserId "00aa00aa-bb11-cc22-dd33-44ee44ee44e" -Top XY } | Should -Throw "Cannot process argument transformation on parameter 'Top'*"
        }
