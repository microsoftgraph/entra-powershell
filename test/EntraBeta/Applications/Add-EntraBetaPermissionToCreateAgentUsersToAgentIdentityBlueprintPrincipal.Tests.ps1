...
Describe "Tests for Add-EntraBetaPermissionToCreateAgentUsersToAgentIdentityBlueprintPrincipal" {
    ...
    BeforeAll {
        ...
        Mock -CommandName Get-EntraContext -MockWith { @{Scopes = @("AgentIdentityBlueprint.UpdateAuthProperties.All", "AgentIdUser.ReadWrite.IdentityParentedBy") } } -ModuleName Microsoft.Entra.Beta.Applications
