...
Describe "Microsoft.Graph.Entra.Groups Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Groups
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Groups
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Graph.Entra.Groups.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Graph.Entra.Groups -ErrorAction SilentlyContinue").Invoke()
