...
BeforeAll {  
    ...
    Mock -CommandName Update-MgGroupLifecyclePolicy -MockWith $scriptblock -ModuleName Microsoft.Entra.Groups
...
Describe "Set-EntraGroupLifecyclePolicy" {
    Context "Test for Set-EntraGroupLifecyclePolicy" {
        It "Should return updated GroupLifecyclePolicy" {
            ...
            Should -Invoke -CommandName Update-MgGroupLifecyclePolicy -ModuleName Microsoft.Entra.Groups -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Update-MgGroupLifecyclePolicy -ModuleName Microsoft.Entra.Groups -Times 1 -ParameterFilter {
