...
Describe "Get-EntraDeletedGroup" {
    Context "Test for Get-EntraDeletedGroup" {
        It "Should return specific deleted Group" {
            $result = Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926"
        ...
        It "Should return specific deleted Group with alias" {
            $result = Get-EntraDeletedGroup -Id "83ec0ff5-f16a-4ba3-b8db-74919eda4926"
            $result | Should -Not -BeNullOrEmpty
            $result.Id | Should -Be "83ec0ff5-f16a-4ba3-b8db-74919eda4926"
            $result.DisplayName | Should -Be "ADC Group"
            $result.GroupTypes | Should -Be "Unified"
        ...
        It "Should fail when All is invalid" {
            { Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926" -All xyz } | Should -Throw "A positional parameter cannot be found that accepts argument 'xyz'.*"
        }
        ...
        It "Should fail when Top is empty" {
            { Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926" -Top } | Should -Throw "Missing an argument for parameter 'Top'*"
        }
        It "Should fail when Top is invalid" {
            { Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926" -Top xyz } | Should -Throw "Cannot process argument transformation on parameter 'Top'*"
        }
        ...
        It "Property parameter should work" {
            $result = Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926" -Property DisplayName
            $result | Should -Not -BeNullOrEmpty
            $result.DisplayName | Should -Be 'ADC Group'
        ...
        It "Should fail when Property is empty" {
            { Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926" -Property } | Should -Throw "Missing an argument for parameter 'Property'*"
        }
        ...
        It "Should execute successfully without throwing an error " {
            ...
            try {
                ...
                { Get-EntraDeletedGroup -GroupId "83ec0ff5-f16a-4ba3-b8db-74919eda4926" -Debug } | Should -Not -Throw
            }
            finally {
