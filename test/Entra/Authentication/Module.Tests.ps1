...
Describe "Microsoft.Entra.Authentication Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Entra.Authentication
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Entra.Authentication
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Entra.Authentication.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Entra.Authentication -ErrorAction SilentlyContinue").Invoke()
