    ...
    Context "Test for Set-EntraPartnerInformation" {
        ...
        It "Should execute successfully without throwing an error" {
            ...
            try {
                ...
                { Set-EntraPartnerInformation -PartnerSupportUrl "http://www.test1.com" -PartnerCommerceUrl "http://www.test1.com" -PartnerHelpUrl "http://www.test1.com" -PartnerSupportEmails "contoso@example.com" -PartnerSupportTelephones "2342" -Debug } | Should -Not -Throw
            }
            finally {
