...
Describe "Set-EntraDomainFederationSettings" {
    Context "Test for Set-EntraDomainFederationSettings" {
        ...
        It "Should Updates settings for a federated domain." {
            ...
            Should -Invoke -CommandName Update-MgDomainFederationConfiguration -ModuleName Microsoft.Entra.DirectoryManagement -Times 1
        }
       ...
       It "Should fail when SigningCertificate is empty" {
        ...
        It "Should contain DomainId in parameters when DomainName to it" {
            Mock -CommandName Update-MgDomainFederationConfiguration -MockWith {$args} -ModuleName Microsoft.Entra.DirectoryManagement
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Update-MgDomainFederationConfiguration -ModuleName Microsoft.Entra.DirectoryManagement -Times 1 -ParameterFilter {
