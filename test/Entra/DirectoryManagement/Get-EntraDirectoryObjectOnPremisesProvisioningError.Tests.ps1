BeforeAll {
    ...
    # Mock the Invoke-GraphRequest command with a proper response
...
Describe "Get-EntraDirectoryObjectOnPremisesProvisioningError" {
    Context "Test for Get-EntraDirectoryObjectOnPremisesProvisioningError" {
        ...
        It "Should return an empty object when TenantId is passed" {
        ...
        It "Should fail when an invalid parameter is passed" {
