...
Describe "Microsoft.Graph.Entra.DirectoryManagement Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.DirectoryManagement
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.DirectoryManagement
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Graph.Entra.DirectoryManagement.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Graph.Entra.DirectoryManagement -ErrorAction SilentlyContinue").Invoke()
