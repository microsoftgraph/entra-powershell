...
$scriptblock = {
    ...
    Mock -CommandName Get-MgDomainVerificationDnsRecord -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.DirectoryManagement
}   
...
Describe "Get-EntraDomainVerificationDnsRecord" {
    Context "Test for Get-EntraDomainVerificationDnsRecord" {
        It "Should return specific domain verification Dns record" {
            ...
            Should -Invoke -CommandName Get-MgDomainVerificationDnsRecord -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgDomainVerificationDnsRecord -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1 -ParameterFilter {
