...
Describe "Resolve-EntraIdTenant" {
    Context "Valid Inputs" {
        It "Should resolve tenant by GUID" {
            $result = Resolve-EntraIdTenant -TenantValue "12345678-1234-1234-1234-123456789abc"
    ...
    Context "Invalid Inputs" {
        It "Should return NotFound for unknown tenant" {
            ...
            $result = Resolve-EntraIdTenant -TenantValue "unknown.onmicrosoft.com"
        ...
        It "Should return Skipped for invalid tenant value" {
            $result = Resolve-EntraIdTenant -TenantValue "invalid_value"
        ...
        It "Should fail when TenantValue is empty" {
            { Resolve-EntraIdTenant -TenantValue } | Should -Throw "Missing an argument for parameter 'TenantValue'*"
        }
    }
