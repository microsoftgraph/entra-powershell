...
Describe "Microsoft.Entra.Applications Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Entra.Applications
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Entra.Applications
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Entra.Applications.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Entra.Applications -ErrorAction SilentlyContinue").Invoke()
