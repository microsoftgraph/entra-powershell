...
BeforeAll {  
    ...
    Mock -CommandName Update-MgIdentityConditionalAccessNamedLocation -MockWith {} -ModuleName Microsoft.Entra.SignIns
...
Describe "Set-EntraNamedLocationPolicy" {
    Context "Test for Set-EntraNamedLocationPolicy" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Update-MgIdentityConditionalAccessNamedLocation -ModuleName Microsoft.Entra.SignIns -Times 1
        }
        ...
        It "Should contain NamedLocationId in parameters when passed PolicyId to it" {
            Mock -CommandName Update-MgIdentityConditionalAccessNamedLocation -MockWith {$args} -ModuleName Microsoft.Entra.SignIns
        ...
        It "Should contain @odata.type in bodyparameters when passed OdataId to it" {
            ...
            Should -Invoke -CommandName Update-MgIdentityConditionalAccessNamedLocation -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
