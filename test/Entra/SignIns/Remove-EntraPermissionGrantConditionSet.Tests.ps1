...
Describe "Remove-EntraPermissionGrantConditionSet"{
    Context "Test for Remove-EntraPermissionGrantConditionSet" {
        It "Should delete a permission grant condition set 'includes' from a policy"{
            ...
            Should -Invoke -CommandName Remove-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 1
        }
        ...
        It "Should delete a permission grant condition set 'excludes' from a policy"{
            ...
            Should -Invoke -CommandName Remove-MgPolicyPermissionGrantPolicyExclude -ModuleName Microsoft.Entra.SignIns -Times 1
        }
        ...
        It "Should contain PermissionGrantPolicyId in parameters when passed PolicyId to it" {   
            Mock -CommandName Remove-MgPolicyPermissionGrantPolicyInclude -MockWith {$args} -ModuleName Microsoft.Entra.SignIns
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
