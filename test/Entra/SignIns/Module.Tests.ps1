...
Describe "Microsoft.Entra.SignIns Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Entra.SignIns
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Entra.SignIns
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Entra.SignIns.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Entra.SignIns -ErrorAction SilentlyContinue").Invoke()
