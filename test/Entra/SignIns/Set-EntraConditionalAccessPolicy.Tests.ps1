...
BeforeAll {  
    ...
    Mock -CommandName Update-MgIdentityConditionalAccessPolicy -MockWith {} -ModuleName Microsoft.Entra.SignIns
...
Describe "Set-EntraConditionalAccessPolicy" {
    Context "Test for Set-EntraConditionalAccessPolicy" {
        It "Should updates a conditional access policy in Microsoft Entra ID by PolicyId" {
            ...
            Should -Invoke -CommandName Update-MgIdentityConditionalAccessPolicy -ModuleName Microsoft.Entra.SignIns -Times 1
        }
        ...
        It "Should contain ConditionalAccessPolicyId in parameters when passed PolicyId to it" {
            Mock -CommandName Update-MgIdentityConditionalAccessPolicy -MockWith {$args} -ModuleName Microsoft.Entra.SignIns
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Update-MgIdentityConditionalAccessPolicy -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
