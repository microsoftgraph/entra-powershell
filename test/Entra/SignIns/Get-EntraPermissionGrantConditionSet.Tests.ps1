...
Describe "Get-EntraPermissionGrantConditionSet"{
    It "Should throw when not connected and not invoke SDK call" {
        ...
        { Get-EntraPermissionGrantConditionSet -PolicyId "policy1" -ConditionSetType "includes" -Id "aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb"  } | Should -Throw "Not connected to Microsoft Graph*"
        Should -Invoke -CommandName Get-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 0
    }
    ...
    It "Should not return empty object for condition set 'includes'"{
        ...
        Should -Invoke -CommandName Get-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 1
    }
    It "Should not return empty object for condition set 'excludes'"{
        ...
        $result | Should -Not -BeNullOrEmpty
        Should -Invoke -CommandName Get-MgPolicyPermissionGrantPolicyExclude -ModuleName Microsoft.Entra.SignIns -Times 1
    }
    ...
    It "Should contain 'User-Agent' header" {
        ...
        $result | Should -Not -BeNullOrEmpty
        $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraPermissionGrantConditionSet"    
        Should -Invoke -CommandName Get-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
