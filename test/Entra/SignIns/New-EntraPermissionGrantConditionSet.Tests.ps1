...
BeforeAll {  
    ...
    Mock -CommandName New-MgPolicyPermissionGrantPolicyInclude -MockWith $scriptblock -ModuleName Microsoft.Entra.SignIns

    Mock -CommandName New-MgPolicyPermissionGrantPolicyExclude -MockWith $scriptblock -ModuleName Microsoft.Entra.SignIns
...
Describe "New-EntraPermissionGrantConditionSet"{
    It "Should not return empty object for condition set 'includes'"{
        ...
        Should -Invoke -CommandName New-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 1
    }
    It "Should not return empty object for condition set 'excludes'"{
        ...
        $result | Should -Not -BeNullOrEmpty
        Should -Invoke -CommandName New-MgPolicyPermissionGrantPolicyExclude -ModuleName Microsoft.Entra.SignIns -Times 1
    }
    ...
    It "Should contain 'User-Agent' header" {
        ...
        $result | Should -Not -BeNullOrEmpty
        $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion New-EntraPermissionGrantConditionSet"
        Should -Invoke -CommandName New-MgPolicyPermissionGrantPolicyInclude -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
