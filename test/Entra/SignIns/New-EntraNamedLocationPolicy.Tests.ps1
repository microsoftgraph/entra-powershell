...
Context "Test for New-EntraNamedLocationPolicy" {
        It "Should return created Ms named location policy" {
            ...
            Should -Invoke -CommandName New-MgIdentityConditionalAccessNamedLocation -ModuleName Microsoft.Entra.SignIns -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName New-MgIdentityConditionalAccessNamedLocation -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
