...
Describe "Get-EntraTrustedCertificateAuthority"{
    It "Result should not be empty when no parameter passed" {
        ...
        Should -Invoke -CommandName Get-MgOrganizationCertificateBasedAuthConfiguration -ModuleName Microsoft.Entra.SignIns -Times 1
    }
    ...
    It "Should contain 'User-Agent' header" {
        ...
        $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraTrustedCertificateAuthority"
        Should -Invoke -CommandName Get-MgOrganizationCertificateBasedAuthConfiguration -ModuleName Microsoft.Entra.SignIns -Times 1 -ParameterFilter {
