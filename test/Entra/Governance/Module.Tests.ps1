...
Describe "Microsoft.Graph.Entra.Governance Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Governance
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Governance
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Graph.Entra.Governance.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Graph.Entra.Governance -ErrorAction SilentlyContinue").Invoke()
