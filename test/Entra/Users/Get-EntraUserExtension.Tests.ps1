...
BeforeAll {
    ...
    $scriptblock = {
        @{
            "id"                = "7115c6ba-0a4a-41c3-a4a2-4e6c12987f2a"
            "employeeId"        = "EK123456"
...
Describe "Tests for Get-EntraUserExtension" {
    It "Result should not be empty" {
        $result = Get-EntraUserExtension -UserId "aaaaaaaa-1111-2222-3333-bbbbbbbbbbbb"
    ...
    It "Should execute successfully without throwing an error " {
        ...
        try {
            ...
            { Get-EntraUserExtension -UserId "SawyerM@contoso.com" -Debug } | Should -Not -Throw
        }
        finally {
