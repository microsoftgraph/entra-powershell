...
Describe "Set-EntraUser" {
    Context "Test for Set-EntraUser" {
        It "Should return empty object" {
            $result = Set-EntraUser -UserId "bbbbbbbb-1111-2222-3333-cccccccccccc" -DisplayName "demo002" -UserPrincipalName "demo001@M365x99297270.OnMicrosoft.com" -MailNickName "demo002NickName" -AgeGroup "adult" -PostalCode "10001"
        ...
        It "Should return empty object with alias" {
            $result = Set-EntraUser -ObjectId "bbbbbbbb-1111-2222-3333-cccccccccccc" -DisplayName "demo002" -UserPrincipalName "demo001@M365x99297270.OnMicrosoft.com"
            $result | Should -BeNullOrEmpty
        }
