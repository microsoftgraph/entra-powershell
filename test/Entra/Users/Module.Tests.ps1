...
Describe "Microsoft.Entra.Users Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Entra.Users
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Entra.Users
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Entra.Users.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Entra.Users -ErrorAction SilentlyContinue").Invoke()
