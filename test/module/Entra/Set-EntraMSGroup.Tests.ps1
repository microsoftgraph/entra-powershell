...
Describe "Set-EntraMSGroup" {
    Context "Test for Set-EntraMSGroup" {
        ...
        It "Should fail when IsAssignableToRole is inavlid" {
            { Set-EntraMSGroup -Id "2c199eed-f77f-4cf4-9270-299071598fa7" -IsAssignableToRole "" } | Should -Throw "Cannot process argument transformation on parameter 'IsAssignableToRole'.*"
        } 
        ...
        It "Should fail when MailEnabled is inavlid" {
            { Set-EntraMSGroup -Id "2c199eed-f77f-4cf4-9270-299071598fa7" -MailEnabled ""} | Should -Throw "Cannot process argument transformation on parameter 'MailEnabled'.*"
        } 
