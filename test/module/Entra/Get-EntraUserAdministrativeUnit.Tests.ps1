...
BeforeAll {
    ...
    Mock -CommandName Get-MgUserMemberOfAsAdministrativeUnit -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra
}
...
Describe "Get-EntraUserAdministrativeUnit" {
    Context "Test for Get-EntraUserAdministrativeUnit" {
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraUserAdministrativeUnit"
            Should -Invoke -CommandName Get-MgUserMemberOfAsAdministrativeUnit -ModuleName Microsoft.Graph.Entra -Times 1 -ParameterFilter {
