...
BeforeAll {
    ...
    Mock -CommandName Get-MgDirectoryDeletedItemAsDevice -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra
}
...
Describe "Get-EntraDeletedDevice" {
    Context "Test for Get-EntraDeletedDevice" {
        It "Should return all devices" {
            ...
            Should -Invoke -CommandName Get-MgDirectoryDeletedItemAsDevice -ModuleName Microsoft.Graph.Entra -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraDeletedDevice"
            Should -Invoke -CommandName Get-MgDirectoryDeletedItemAsDevice -ModuleName Microsoft.Graph.Entra -Times 1 -ParameterFilter {
