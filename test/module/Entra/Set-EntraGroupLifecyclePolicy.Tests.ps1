...
Describe "Set-EntraGroupLifecyclePolicy " {
    Context "Test for Set-EntraGroupLifecyclePolicy" {
        ...
        It "Should fail when GroupLifetimeInDays is invalid" {
            { Set-EntraGroupLifecyclePolicy -Id a47d4510-08c8-4437-99e9-71ca88e7af0f -GroupLifetimeInDays a -ManagedGroupTypes "Selected" -AlternateNotificationEmails "example@contoso.com" } | Should -Throw "Cannot process argument transformation on parameter 'GroupLifetimeInDays'.*"
        }
        It "Should fail when GroupLifetimeInDays is empty" {
            { Set-EntraGroupLifecyclePolicy -Id a47d4510-08c8-4437-99e9-71ca88e7af0f -GroupLifetimeInDays  -ManagedGroupTypes "Selected" -AlternateNotificationEmails "example@contoso.com" } | Should -Throw "Missing an argument for parameter 'GroupLifetimeInDays'.*"
        } 
        It "Should fail when ManagedGroupTypes is empty" {
            { Set-EntraGroupLifecyclePolicy -Id a47d4510-08c8-4437-99e9-71ca88e7af0f -GroupLifetimeInDays 99 -ManagedGroupTypes  -AlternateNotificationEmails "example@contoso.com" } | Should -Throw "Missing an argument for parameter 'ManagedGroupTypes'.*"
        }
        It "Should fail when AlternateNotificationEmails is empty" {
            { Set-EntraGroupLifecyclePolicy -Id a47d4510-08c8-4437-99e9-71ca88e7af0f -GroupLifetimeInDays 99 -ManagedGroupTypes "Selected" -AlternateNotificationEmails } | Should -Throw "Missing an argument for parameter 'AlternateNotificationEmails'.*"
        }
