...
Describe "Remove-EntraDeviceRegisteredOwner" {
    Context "Test for Remove-EntraDeviceRegisteredOwner" {
        ...
        It "Should fail when ObjectId is empty" {
            { Remove-EntraDeviceRegisteredOwner -ObjectId  -OwnerId "bbbbbbbb-1111-2222-3333-cccccccccccc" | Should -Throw "Missing an argument for parameter 'ObjectId'*" }
        }
        It "Should fail when ObjectId is invalid" {
            { Remove-EntraDeviceRegisteredOwner -ObjectId "" -OwnerId "bbbbbbbb-1111-2222-3333-cccccccccccc" | Should -Throw "Cannot bind argument to parameter 'ObjectId' because it is an empty string.*" }
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgDeviceRegisteredOwnerByRef -ModuleName Microsoft.Graph.Entra -Times 1 -ParameterFilter {
