...
Describe "Test for Set-EntraMSCustomSecurityAttributeDefinitionAllowedValue" {
    ...
    It "Should return empty object" {
        $result = Set-EntraMSCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId "Engineering_Project" -AllowedValueId "Alpine" -IsActive $true
    ...
    It "Should fail when AllowedValueId is empty" {
        { Set-EntraMSCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId "Engineering_Project" -AllowedValueId "" } | Should -Throw "Cannot bind argument to parameter 'AllowedValueId'*"
    }
    It "Should fail when AllowedValueId is null" {
        { Set-EntraMSCustomSecurityAttributeDefinitionAllowedValue -CustomSecurityAttributeDefinitionId "Engineering_Project" -AllowedValueId } | Should -Throw "Missing an argument for parameter 'AllowedValueId'*"
    }
