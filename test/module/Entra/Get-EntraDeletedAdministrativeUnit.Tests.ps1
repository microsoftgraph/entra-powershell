...
BeforeAll {
    ...
    Mock -CommandName Get-MgDirectoryDeletedItemAsAdministrativeUnit -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra
}
...
Describe "Get-EntraDeletedAdministrativeUnit" {
    Context "Test for Get-EntraDeletedAdministrativeUnit" {
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraDeletedAdministrativeUnit"
            Should -Invoke -CommandName Get-MgDirectoryDeletedItemAsAdministrativeUnit -ModuleName Microsoft.Graph.Entra -Times 1 -ParameterFilter {
