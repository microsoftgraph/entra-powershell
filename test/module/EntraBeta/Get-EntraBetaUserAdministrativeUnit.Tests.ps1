...
BeforeAll {
    ...
    Mock -CommandName Get-MgBetaUserMemberOfAsAdministrativeUnit -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Get-EntraBetaUserAdministrativeUnit" {
    Context "Test for Get-EntraBetaUserAdministrativeUnit" {
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraBetaUserAdministrativeUnit"
            Should -Invoke -CommandName Get-MgBetaUserMemberOfAsAdministrativeUnit -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
