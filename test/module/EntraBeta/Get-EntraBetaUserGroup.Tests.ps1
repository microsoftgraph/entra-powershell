...
BeforeAll {
    ...
    Mock -CommandName Get-MgBetaUserMemberOfAsGroup -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Get-EntraBetaUserGroup" {
    Context "Test for Get-EntraBetaUserGroup" {
        It "Should return all user roles" {
            ...
            Should -Invoke -CommandName Get-MgBetaUserMemberOfAsGroup -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraBetaUserGroup"
            Should -Invoke -CommandName Get-MgBetaUserMemberOfAsGroup -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
