...
Describe "New-EntraBetaUser" {
    Context "Test for New-EntraBetaUser" {
        ...
        It "Should contain MobilePhone in parameters when passed Mobile to it" {
            ...
            $result = New-EntraBetaUser -DisplayName "demo002" -PasswordProfile $PasswordProfile -UserPrincipalName "demo001@M365x99297270.OnMicrosoft.com" -AccountEnabled $true -MailNickName "demo002NickName" -AgeGroup "adult" -Mobile "1234567890"
