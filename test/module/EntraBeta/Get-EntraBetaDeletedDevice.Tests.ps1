...
BeforeAll {
    ...
    Mock -CommandName Get-MgBetaDirectoryDeletedItemAsDevice -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Get-EntraBetaDeletedDevice" {
    Context "Test for Get-EntraBetaDeletedDevice" {
        It "Should return all devices" {
            ...
            Should -Invoke -CommandName Get-MgBetaDirectoryDeletedItemAsDevice -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraBetaDeletedDevice"
            Should -Invoke -CommandName Get-MgBetaDirectoryDeletedItemAsDevice -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
