...
BeforeAll {
    ...
    Mock -CommandName Get-MgBetaDeviceRegisteredOwner -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Get-EntraBetaDeviceRegisteredOwner" {
    Context "Test for Get-EntraBetaDeviceRegisteredOwner" {
        It "Should return specific device registered owner" {
            ...
            Should -Invoke -CommandName Get-MgBetaDeviceRegisteredOwner -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgBetaDeviceRegisteredOwner -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
