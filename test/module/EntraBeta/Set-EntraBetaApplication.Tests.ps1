...
Describe "Set-EntraBetaApplication"{
    Context "Test for Set-EntraBetaApplication" {
        It "Should return empty object"{
            $result = Set-EntraBetaApplication -ObjectId 056b2531-005e-4f3e-be78-01a71ea30a04 -DisplayName "Mock-App"
        ...
        It "Should contain ApplicationId in parameters when passed ObjectId to it" {
            ...
            $result = Set-EntraBetaApplication -ObjectId 056b2531-005e-4f3e-be78-01a71ea30a04
