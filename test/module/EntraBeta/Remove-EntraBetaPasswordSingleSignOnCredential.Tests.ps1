...
Describe "Remove-EntraBetaPasswordSingleSignOnCredential" {
    Context "Test for Remove-EntraBetaPasswordSingleSignOnCredential" {
        It "Should remove password single-sign-on credentials" {
            $result = Remove-EntraBetaPasswordSingleSignOnCredential -ObjectId "cc7fcc82-ac1b-4785-af47-2ca3b7052886"  -PasswordSSOObjectId "bbf5d921-bb52-434b-96a0-95888e44faf5"
        ...
        It "Should fail when ObjectId is empty" {
            { Remove-EntraBetaPasswordSingleSignOnCredential -ObjectId   -PasswordSSOObjectId bbf5d921-bb52-434b-96a0-95888e44faf5 } | Should -Throw "Missing an argument for parameter 'ObjectId'*"
        }   

        It "Should fail when ObjectId is invalid" {
            { Remove-EntraBetaPasswordSingleSignOnCredential -ObjectId ""  -PasswordSSOObjectId bbf5d921-bb52-434b-96a0-95888e44faf5 } | Should -Throw "Cannot bind argument to parameter 'ObjectId' because it is an empty string."
        }   

        It "Should fail when PasswordSSOObjectId is empty" {
            { Remove-EntraBetaPasswordSingleSignOnCredential -ObjectId "cc7fcc82-ac1b-4785-af47-2ca3b7052886"  -PasswordSSOObjectId   } | Should -Throw "Missing an argument for parameter 'PasswordSSOObjectId'*"
        }   
