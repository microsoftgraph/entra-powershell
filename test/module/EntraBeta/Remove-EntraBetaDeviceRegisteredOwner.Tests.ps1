...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgBetaDeviceRegisteredOwnerByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Remove-EntraBetaDeviceRegisteredOwner" {
    Context "Test for Remove-EntraBetaDeviceRegisteredOwner" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgBetaDeviceRegisteredOwnerByRef -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain DeviceId in parameters when passed OwnerId to it" {
            Mock -CommandName Remove-MgBetaDeviceRegisteredOwnerByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgBetaDeviceRegisteredOwnerByRef -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
