...
Describe "Get-EntraBetaUserRegisteredDevice" {
    Context "Test for Get-EntraBetaUserRegisteredDevice" {
        ...
        It "Should fail when ObjectlId is empty" {
            { Get-EntraBetaUserRegisteredDevice -UserId    } | Should -Throw "Missing an argument for parameter 'ObjectId'*"
        }
        It "Should fail when ObjectlId is invalid" {
            { Get-EntraBetaUserRegisteredDevice -UserId  ""} | Should -Throw "Cannot bind argument to parameter 'ObjectId' because it is an empty string."
        }
