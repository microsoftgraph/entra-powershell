...
Describe "Get-EntraBetaUserInactiveSignIn" {
    Context "Test for Get-EntraBetaUserInactiveSignIn" {
        ...
        It "Should fail when Ago is invalid" {
            { Get-EntraBetaUserInactiveSignIn -Ago "MSFT" } | Should -Throw "Ago should be a number.*"
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgBetaUser -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
