...
description: This article provides details on the Get-EntraBetaObjectByObjectId command.
...
The `Get-EntraBetaObjectByObjectId` cmdlet retrieves directory objects based on a list of IDs (a list of up to 1000 GUIDs (as strings) to retrieve objects for).
...
Get-EntraBetaObjectByObjectId -DirectoryObjectId 'aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb' , 'bbbbbbbb-1111-2222-3333-cccccccccccc' | 
