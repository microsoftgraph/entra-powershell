...
```
Set-EntraBetaMSNamedLocationPolicy [-IncludeUnknownCountriesAndRegions <Boolean>] [-Id <String>]
...
```
PS C:\> Set-EntraBetaMSNamedLocationPolicy -PolicyId 07a1f48d-0cbb-4c2c-8ea2-1ea00e3eb3b6 -OdataType "#microsoft.graph.ipNamedLocation" -IsTrusted $false
```
...
```
PS C:\> Set-EntraBetaMSNamedLocationPolicy -PolicyId 76fdfd4d-bd80-4c1e-8fd4-6abf49d121fe -OdataType "#microsoft.graph.countryNamedLocation" -IncludeUnknownCountriesAndRegions $true
```
