...
1. Get exisiting permission grant policy by that need to be updated.
		...
		$permissionGrantConditionSet =Get-EntraBetaMSPermissionGrantConditionSet -PolicyId "test1" -ConditionSetType "includes" -Id "0f81cce0-a766-4db6-a7e2-4e5f10f6abf8"
		...
		Set-EntraBetaMSPermissionGrantConditionSet -PolicyId "test1" -ConditionSetType "includes" -Id $permissionGrantConditionSet.Id -PermissionClassification low
