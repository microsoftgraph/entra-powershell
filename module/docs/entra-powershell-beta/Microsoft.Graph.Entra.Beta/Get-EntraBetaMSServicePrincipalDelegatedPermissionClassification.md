...
# Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification
...
### GetQuery (Default)
```
Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification [-Filter <String>]
 -ServicePrincipalId <String> [<CommonParameters>]
```

### GetById
```
Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification -ServicePrincipalId <String> -Id <String>
 [<CommonParameters>]
```

## Description
The Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification cmdlet retrieves the delegated permission classifications from a service principal.

## Examples

### Example 1: Get a list of delegated permission classifications
```
PS C:\> Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification -ServicePrincipalId "95f56359-0165-4f80-bffb-c89d06cf2c6f"
...
```
PS C:\> Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification -ServicePrincipalId "95f56359-0165-4f80-bffb-c89d06cf2c6f" -Id "5XBeIKarUkypdm0tRsSAQwE"
...
```
PS C:\> Get-EntraBetaMSServicePrincipalDelegatedPermissionClassification -ServicePrincipalId "95f56359-0165-4f80-bffb-c89d06cf2c6f" -Filter "PermissionName eq 'Sites.Read.All'"
