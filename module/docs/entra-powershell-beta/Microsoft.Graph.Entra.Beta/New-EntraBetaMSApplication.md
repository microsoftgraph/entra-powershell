---
title: New-EntraBetaMSApplication
description: This article provides details on the New-EntraBetaMSApplication command.
...
New-EntraBetaMSApplication -DisplayName 'My new application'
```
...
```powershell
Connect-Entra -Scopes 'Application.ReadWrite.All'
New-EntraBetaMSApplication -DisplayName 'My new application' -IdentifierUris 'https://mynewapp.contoso.com'
```
...
New-EntraBetaMSApplication -DisplayName 'My new application' -Api $api
```
...
New-EntraBetaMSApplication -DisplayName 'My new application' -AppRoles $approle
```
...
New-EntraBetaMSApplication -DisplayName 'My new application' -OptionalClaims $optionalClaims
```
