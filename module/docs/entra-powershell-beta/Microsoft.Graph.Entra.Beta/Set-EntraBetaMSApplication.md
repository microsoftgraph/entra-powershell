---
title: Set-EntraBetaMSApplication
description: This article provides details on the Set-EntraBetaMSApplication command.
...
Set-EntraBetaMSApplication -ObjectId 'aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb' -DisplayName 'My new application'
```
...
```powershell
Connect-Entra -Scopes 'Application.ReadWrite.All'
Set-EntraBetaMSApplication -ObjectId 'aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb' -IdentifierUris 'https://mynewapp.contoso.com'
```
...
```powershell
Connect-Entra -Scopes 'Application.ReadWrite.All'
Set-EntraBetaMSApplication -ObjectId 'aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb' -GroupMembershipClaims 'SecurityGroup'
```
...
```powershell
Connect-Entra -Scopes 'Application.ReadWrite.All'
Set-EntraBetaMSApplication -ObjectId 'aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb' -IsDeviceOnlyAuthSupported $false
```
...
```powershell
Connect-Entra -Scopes 'Application.ReadWrite.All'
Set-EntraBetaMSApplication -ObjectId 'aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb' -Tags 'mytag'
```
