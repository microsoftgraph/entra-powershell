...
This example shows how to get a user's password profile. To update it, run `Get-EntraUser -UserId SawyerM@contoso.com | Set-EntraUser -PasswordPolicies DisablePasswordExpiration`.
