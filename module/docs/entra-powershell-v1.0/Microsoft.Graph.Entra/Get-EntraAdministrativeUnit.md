...
```powershell
PS C:\> Get-EntraAdministrativeUnit
```
...
```powershell
PS C:\> Get-EntraAdministrativeUnit -All 
```
...
```powershell
PS C:\> Get-EntraAdministrativeUnit -Id 4bfe2ef5-9c2b-4118-9a3a-6e540c37920c
```
...
```powershell
PS C:\> Get-EntraAdministrativeUnit -Filter "DisplayName eq 'DAU-Test'"
```
...
```powershell
PS C:\> Get-EntraAdministrativeUnit -Top 1
```
