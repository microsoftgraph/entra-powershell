...
```powershell
PS C:\>Set-EntraAuthorizationPolicy -DisplayName "updated displayname" -Description "updated description"  -BlockMsolPowerShell $true -AllowedToUseSSPR $false -AllowEmailVerifiedUsersToJoinOrganization $true -AllowedToSignUpEmailBasedSubscriptions $true  
```
...
PS C:\> Set-EntraAuthorizationPolicy -DefaultUserRolePermissions $DefaultUserRolePermissions 
```
