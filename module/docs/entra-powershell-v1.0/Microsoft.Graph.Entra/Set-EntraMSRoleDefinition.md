...
```powershell
 ...
 Set-EntraMSRoleDefinition -ID a0a0a0a0-bbbb-cccc-dddd-e1e1e1e1e1e1 -DisplayName 'UpdatedDisplayName'
```
...
```powershell
 Connect-Entra -Scopes 'RoleManagement.ReadWrite.Directory'
 Set-EntraMSRoleDefinition -Id a0a0a0a0-bbbb-cccc-dddd-e1e1e1e1e1e1 -Description 'MYROLEUPDATE1S'
```
...
```powershell
 Connect-Entra -Scopes 'RoleManagement.ReadWrite.Directory'
 Set-EntraMSRoleDefinition -Id a0a0a0a0-bbbb-cccc-dddd-e1e1e1e1e1e1 -IsEnabled $true
```
...
```powershell
 ...
 Set-EntraMSRoleDefinition @params
```
