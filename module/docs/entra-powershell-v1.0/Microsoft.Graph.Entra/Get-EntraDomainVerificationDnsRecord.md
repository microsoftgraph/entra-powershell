...
```
Get-EntraDomainVerificationDnsRecord -Name <String> [<CommonParameters>]
```
...
### Example 1
```
PS C:\WINDOWS\system32> Get-EntraDomainVerificationDnsRecord -Name drumkit.onmicrosoft.com
