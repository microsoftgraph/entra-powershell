...
```powershell
PS C:\> Get-EntraRoleDefinition -Id 1a327991-10cb-4266-877a-998fb4df78ec
```
...
```powershell
PS C:\> Get-EntraRoleDefinition -Filter "startswith(displayName, 'Sample')"
```
