...
```powershell
PS C:\> Get-EntraAdministrativeUnitMember -Id "ef08b536-9d0a-4f8f-bda5-8b9cd01a9159"
```
...
```powershell
PS C:\> Get-EntraAdministrativeUnitMember -Id "ef08b536-9d0a-4f8f-bda5-8b9cd01a9159" -All
```
...
```powershell
PS C:\> Get-EntraAdministrativeUnitMember -Id "ef08b536-9d0a-4f8f-bda5-8b9cd01a9159" -Top 2
```
