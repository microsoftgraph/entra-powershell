...
```
Get-EntraDomainServiceConfigurationRecord -Name <String> [<CommonParameters>]
```
...
### Example 1
```
PS C:\WINDOWS\system32> Get-EntraDomainServiceConfigurationRecord -name drumkit.onmicrosoft.com
