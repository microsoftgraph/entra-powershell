...
```
Set-EntraMSPermissionGrantConditionSet -ConditionSetType <String>
 [-Permissions <System.Collections.Generic.List`1[System.String]>]
 [-ClientApplicationTenantIds <System.Collections.Generic.List`1[System.String]>] -Id <String>
...
1. Get exisiting permission grant policy by that need to be updated.
		...
		$permissionGrantConditionSet =Get-EntraMSPermissionGrantConditionSet -PolicyId "test1" -ConditionSetType "includes" -Id "0f81cce0-a766-4db6-a7e2-4e5f10f6abf8"
		...
		Set-EntraMSPermissionGrantConditionSet -PolicyId "test1" -ConditionSetType "includes" -Id $permissionGrantConditionSet.Id -PermissionClassification low
