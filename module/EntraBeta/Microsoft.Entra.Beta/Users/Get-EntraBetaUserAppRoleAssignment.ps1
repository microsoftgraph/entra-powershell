...
function Get-EntraBetaUserAppRoleAssignment {
    ...
    param (                
        ...
        [Parameter(ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Return all user's app role assignments.")]
        [switch] $All,
    ...
    PROCESS {    
        ...
        $response = Get-MgBetaUserAppRoleAssignment @params -Headers $customHeaders
