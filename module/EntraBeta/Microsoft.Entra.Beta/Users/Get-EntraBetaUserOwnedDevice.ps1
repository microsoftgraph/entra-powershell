...
# ------------------------------------------------------------------------------ 
function Get-EntraBetaUserOwnedDevice {
    ...
    param (
        ...
        [Parameter(ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Return all user's owned devices.")]
        [switch] $All,
    ...
    PROCESS {    
        ...
        $response = Get-MgBetaUserOwnedDevice @params -Headers $customHeaders
