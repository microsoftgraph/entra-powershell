...
# ------------------------------------------------------------------------------ 
function Get-EntraBetaUserMembership {
    ...
    param (          
        ...
        [Parameter(ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Return all user's memberships.")]
        [switch] $All,
    ...
    PROCESS {    
        ...
        $response = Get-MgBetaUserMemberOf @params -Headers $customHeaders
