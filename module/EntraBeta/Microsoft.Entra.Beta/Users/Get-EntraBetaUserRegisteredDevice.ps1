...
# ------------------------------------------------------------------------------ 
function Get-EntraBetaUserRegisteredDevice {
    ...
    param (
        ...
        [Parameter(ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Return all registered devices.")]
        [switch] $All,
    ...
    PROCESS {    
        ...
        $response = Get-MgBetaUserRegisteredDevice @params -Headers $customHeaders
