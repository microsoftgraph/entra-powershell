...
# ------------------------------------------------------------------------------ 
function Remove-EntraBetaOAuth2PermissionGrant {
    ...
    PROCESS {    
        ...
        if ($null -ne $PSBoundParameters["OAuth2PermissionGrantId"]) {
            $params["OAuth2PermissionGrantId"] = $PSBoundParameters["OAuth2PermissionGrantId"]
        }
        ...
        $response = Remove-MgBetaOAuth2PermissionGrant @params -Headers $customHeaders
