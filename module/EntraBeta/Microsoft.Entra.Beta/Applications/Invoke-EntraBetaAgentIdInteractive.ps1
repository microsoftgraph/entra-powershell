...
function Invoke-EntraBetaAgentIdInteractive {
    ...
    begin {
        ...
        if (-not $context) {
            $errorMessage = "Not connected to Microsoft Graph. Use 'Connect-Entra -Scopes Organization.Read.All, AgentIdentityBlueprint.Create, AgentIdentityBlueprintPrincipal.Create, AppRoleAssignment.ReadWrite.All, AgentIdentityBlueprint.ReadWrite.All, User.ReadWrite.All' to authenticate."
