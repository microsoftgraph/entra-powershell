...
# ------------------------------------------------------------------------------ 
function Set-EntraBetaApplicationVerifiedPublisher {
    [CmdletBinding(DefaultParameterSetName = 'Default')]
    param (
        [Parameter(Mandatory = $true, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Set verified publisher request.")]
    ...
    PROCESS {    
        ...
        $response = Set-MgBetaApplicationVerifiedPublisher @params -Headers $customHeaders
