...
# ------------------------------------------------------------------------------ 
function Remove-EntraBetaServicePrincipalOwner {
    ...
    param (
        ...
        [Parameter(Mandatory = $true, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Unique ID of the directory object (Directory Object ID).")]
        [ValidateNotNullOrEmpty()]
    ...
    PROCESS {    
        ...
        $response = Remove-MgBetaServicePrincipalOwnerByRef @params -Headers $customHeaders
