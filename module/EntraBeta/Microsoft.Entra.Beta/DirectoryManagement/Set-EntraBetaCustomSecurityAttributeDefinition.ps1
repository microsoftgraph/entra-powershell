...
# ------------------------------------------------------------------------------ 
function Set-EntraBetaCustomSecurityAttributeDefinition {
    ...
    {
        $params["CustomSecurityAttributeDefinitionId"] = $PSBoundParameters["Id"]
    }
    ...
    $response = Update-MgBetaDirectoryCustomSecurityAttributeDefinition @params -Headers $customHeaders
