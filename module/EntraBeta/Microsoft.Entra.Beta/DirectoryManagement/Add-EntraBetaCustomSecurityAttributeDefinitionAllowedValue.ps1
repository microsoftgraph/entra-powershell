...
# ------------------------------------------------------------------------------ 
function Add-EntraBetaCustomSecurityAttributeDefinitionAllowedValue {
    ...
    $response = New-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue @params -Headers $customHeaders
