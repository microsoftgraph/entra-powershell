...
function New-EntraBetaAdministrativeUnit {
    ...
    param (
        ...
        [Parameter(ParameterSetName = "FromParameters", Mandatory = $true, HelpMessage = "Display name of the administrative unit.")]
        [System.String] $DisplayName,

        [Parameter(ParameterSetName = "FromParameters", HelpMessage = "Membership rule for the administrative unit.")]
        [System.String] $MembershipRule,

        [Parameter(ParameterSetName = "FromParameters", HelpMessage = "Membership rule processing state for the administrative unit.")]
        [System.String] $MembershipRuleProcessingState,

        [Parameter(ParameterSetName = "FromParameters", HelpMessage = "Membership type for the administrative unit.")]
        [System.String] $MembershipType,

        [Parameter(ParameterSetName = "FromParameters", HelpMessage = "Visibility of the administrative unit.")]
