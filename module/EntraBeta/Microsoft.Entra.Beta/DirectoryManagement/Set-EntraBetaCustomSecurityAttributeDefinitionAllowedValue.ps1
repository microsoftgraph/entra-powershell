...
# ------------------------------------------------------------------------------ 
function Set-EntraBetaCustomSecurityAttributeDefinitionAllowedValue {
    ...
    {
        $params["AllowedValueId"] = $PSBoundParameters["Id"]
    }
    ...
    $response = Update-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue @params -Headers $customHeaders
