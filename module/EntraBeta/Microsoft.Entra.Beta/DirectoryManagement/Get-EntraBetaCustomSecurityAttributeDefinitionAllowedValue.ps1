...
# ------------------------------------------------------------------------------ 
function Get-EntraBetaCustomSecurityAttributeDefinitionAllowedValue {
    ...
    PROCESS {    
        ...
        $response = Get-MgBetaDirectoryCustomSecurityAttributeDefinitionAllowedValue @params -Headers $customHeaders
