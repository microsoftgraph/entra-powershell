...
# ------------------------------------------------------------------------------ 
function Set-EntraBetaDirectorySetting {
    ...
    {
        $TmpValue = $PSBoundParameters["DirectorySetting"]
    ...
    {
        $params["DirectorySettingId"] = $PSBoundParameters["Id"]
    }
    ...
    $response = Update-MgBetaDirectorySetting @params -Headers $customHeaders
