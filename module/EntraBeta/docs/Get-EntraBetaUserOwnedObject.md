...
```
Get-EntraBetaUserOwnedObject [-Top <Int32>] -ObjectId <String> [-All <Boolean>] [<CommonParameters>]
```

## DESCRIPTION
The Get-EntraBetaUserOwnedObject cmdlet gets objects owned by a user in Azure Active Directory (AD).
