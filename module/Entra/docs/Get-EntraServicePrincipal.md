...
### GetQuery (Default)
```
Get-EntraServicePrincipal [-Top <Int32>] [-All <Boolean>] [-Filter <String>] [<CommonParameters>]
```

### GetVague
```
Get-EntraServicePrincipal [-SearchString <String>] [-All <Boolean>] [<CommonParameters>]
```

### GetById
```
Get-EntraServicePrincipal -ObjectId <String> [-All <Boolean>] [<CommonParameters>]
```
...
This command gets a list of service principal which have the specified display name.
