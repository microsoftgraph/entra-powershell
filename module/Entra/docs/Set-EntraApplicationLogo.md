...
### File (Default)
```
Set-EntraApplicationLogo [-ObjectId <String>] -FilePath <String> [<CommonParameters>]
```

### Stream
```
Set-EntraApplicationLogo -FileStream <Stream> [-ObjectId <String>] [<CommonParameters>]
```

### ByteArray
```
Set-EntraApplicationLogo [-ObjectId <String>] -ImageByteArray <Byte[]> [<CommonParameters>]
```
...
### Example 1
```
PS C:\WINDOWS\system32> Set-EntraApplicationLogo -ObjectId 79592454-dea7-4660-9d91-f1768e5055ac -FilePath D:\applogo.jpg
```
