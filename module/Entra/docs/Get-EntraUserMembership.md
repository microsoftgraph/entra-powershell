...
```
Get-EntraUserMembership [-All <Boolean>] -ObjectId <String> [-Top <Int32>] [<CommonParameters>]
```
...
```
PS C:\>Get-EntraUserMembership  -ObjectId "df19e8e6-2ad7-453e-87f5-037f6529ae16"
