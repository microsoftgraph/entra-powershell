...
function Get-EntraContact {
    ...
    param (
        ...
        [Parameter(Mandatory = $false, ValueFromPipeline = $false, ValueFromPipelineByPropertyName = $false, HelpMessage = "Returns only contacts that have service provisioning errors 1.")]
