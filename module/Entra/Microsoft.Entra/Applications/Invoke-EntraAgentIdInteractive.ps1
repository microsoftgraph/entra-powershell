    ...
    process {
        ...
        try {
            if ($useSponsor) {
                ...
                $blueprint1 = New-EntraAgentIdentityBlueprint -DisplayName $bluePrintDisplayName -SponsorUserIds $SponsorUserIds -OwnerUserIds $SponsorUserIds
            } else {
                $blueprint1 = New-EntraAgentIdentityBlueprint -DisplayName $bluePrintDisplayName
            }
        ...
        $secret1 = Add-EntraClientSecretToAgentIdentityBlueprint
        ...
        if ($hasInteractiveAgents) {
            ...
            $interactiveScope = Add-EntraScopeToAgentIdentityBlueprint
        ...
        if ($hasInheritablePermissions) {
            ...
            $inheritablePerms = Add-EntraInheritablePermissionsToAgentIdentityBlueprint
            ...
            if ($useStaticPermissions) {
                ...
                if ($blueprintWillCreateAgentUsers) {
                    ...
                    if ($agentUserRoleId) {
                        ...
                        $agentUserRra = Add-EntraRequiredResourceAccessToAgentIdentityBlueprint `
                ...
                $additionalRra = Add-EntraRequiredResourceAccessToAgentIdentityBlueprint
        ...
        if (-not $hasInheritablePermissions -and -not $blueprintWillCreateAgentUsers) {
            ...
            $principal1 = New-EntraAgentIdentityBlueprintPrincipal
        ...
        elseif (-not $hasInheritablePermissions -and $blueprintWillCreateAgentUsers) {
            ...
            Add-EntraPermissionsToInheritToAgentIdentityBlueprintPrincipal -Roles $consentRoles
        ...
        elseif ($hasInheritablePermissions -and $useStaticPermissions) {
            ...
            Add-EntraPermissionsToInheritToAgentIdentityBlueprintPrincipal -Scopes $consentScopes
        ...
        elseif ($hasInheritablePermissions -and -not $useStaticPermissions -and $blueprintWillCreateAgentUsers) {
            ...
            Add-EntraPermissionsToInheritToAgentIdentityBlueprintPrincipal -Scopes $consentScopes -Roles $consentRoles
        ...
        while ($continueCreating) {
            ...
            if ($useSponsor) {
                ...
                $agentIdentity = New-EntraAgentIDForAgentIdentityBlueprint -DisplayName $agentIdentityDisplayName `
            ...
            if ($blueprintWillCreateAgentUsers) {
                ...
                if ($agentIDNeedsUser) {
                    ...
                    $agentUser = New-EntraAgentUserForAgentId -DisplayName $agentUserDisplayName `
