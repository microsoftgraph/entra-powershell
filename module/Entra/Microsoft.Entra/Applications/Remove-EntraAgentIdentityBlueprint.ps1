...
function Remove-EntraAgentIdentityBlueprint {
    ...
    process {
        ...
        try {
            ...
            $blueprintUri = "/v1.0/applications/microsoft.graph.agentIdentityBlueprint/$BlueprintId"
            ...
            $identityUri = "/v1.0/servicePrincipals/microsoft.graph.agentIdentity?`$filter=agentIdentityBlueprintId eq '$BlueprintId'"
            $allAgentIdentities = @()
            ...
            if ($allAgentIdentities.Count -gt 0) {
                ...
                foreach ($agentIdentity in $allAgentIdentities) {
                    ...
                    try {
                        ...
                        $deleteIdentityUri = "/v1.0/servicePrincipals/$agentIdValue"
            ...
            $deleteBlueprintUri = "/v1.0/applications/$BlueprintId"
