...
# ------------------------------------------------------------------------------ 
function Remove-EntraServicePrincipalAppRoleAssignment {
    [CmdletBinding(DefaultParameterSetName = 'Default')]
    param (                
        [Parameter(Mandatory = $true, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Unique ID of the app role assignment object (App Role Assignment Object ID).")]
    ...
    PROCESS {    
        ...
        $response = Remove-MgServicePrincipalAppRoleAssignment @params -Headers $customHeaders
