...
# ------------------------------------------------------------------------------ 
function Get-EntraApplicationServiceEndpoint {
    ...
    param (                
        ...
        [Parameter(ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Get all service endpoints.")]
        [switch] $All,
    ...
    PROCESS {    
        ...
        $response = Get-MgServicePrincipalEndpoint @params -Headers $customHeaders
