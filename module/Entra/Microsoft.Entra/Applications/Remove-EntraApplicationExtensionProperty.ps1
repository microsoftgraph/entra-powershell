...
# ------------------------------------------------------------------------------ 
function Remove-EntraApplicationExtensionProperty {
    ...
    param (
        ...
        [Parameter(Mandatory = $true, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, HelpMessage = "Unique ID of the extension property.")]
        [ValidateNotNullOrEmpty()]
        [System.String] $ExtensionPropertyId
    )
    ...
    PROCESS {    
        ...
        $response = Remove-MgApplicationExtensionProperty @params -Headers $customHeaders
