...
function Get-EntraUserInactiveSignIn {
    ...
    process {
        ...
        $QueryUsers = Get-MgUser -Filter $QueryFilter -PageSize 999 -All -Property signInActivity, UserPrincipalName, Id, DisplayName, Mail, UserType, CreatedDateTime, AccountEnabled -Headers $CustomHeaders 
