...
Set-Alias -Name Get-EntraAuthMethodUserRegistrationDetailReport -Value Get-EntraAuthenticationMethodUserRegistrationDetailReport -Description "Retrieves the organization's commercial subscriptions." -Scope Global -Force