...
BeforeAll {
    ...
    Mock -CommandName Get-MgBetaDeviceRegisteredUser -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Get-EntraBetaDeviceRegisteredUser" {
    Context "Test for Get-EntraBetaDeviceRegisteredUser" {
        It "Should return specific device registered User" {
            ...
            Should -Invoke -CommandName Get-MgBetaDeviceRegisteredUser -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgBetaDeviceRegisteredUser -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
