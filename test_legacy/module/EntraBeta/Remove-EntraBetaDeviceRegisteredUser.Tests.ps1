...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgBetaDeviceRegisteredUserByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Remove-EntraBetaDeviceRegisteredUser" {
    Context "Test for Remove-EntraBetaDeviceRegisteredUser" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgBetaDeviceRegisteredUserByRef -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain DeviceId in parameters when passed UserId to it" {
            Mock -CommandName Remove-MgBetaDeviceRegisteredUserByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgBetaDeviceRegisteredUserByRef -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
