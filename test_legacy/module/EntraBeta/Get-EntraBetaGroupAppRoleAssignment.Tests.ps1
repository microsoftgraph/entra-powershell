...
BeforeAll {  
    ...
    Mock -CommandName Get-MgBetaGroupAppRoleAssignment -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Context "Test for Get-EntraBetaGroupAppRoleAssignment" {
        It "Should return specific Group AppRole Assignment" {
            ...
            Should -Invoke -CommandName Get-MgBetaGroupAppRoleAssignment  -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgBetaGroupAppRoleAssignment -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
