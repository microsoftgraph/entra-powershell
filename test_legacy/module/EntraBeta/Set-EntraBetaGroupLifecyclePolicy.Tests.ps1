...
BeforeAll {  
    ...
    Mock -CommandName Update-MgBetaGroupLifecyclePolicy -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Set-EntraBetaGroupLifecyclePolicy" {
    Context "Test for Set-EntraBetaGroupLifecyclePolicy" {
        It "Should return updated GroupLifecyclePolicy" {
            ...
            Should -Invoke -CommandName Update-MgBetaGroupLifecyclePolicy -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Update-MgBetaGroupLifecyclePolicy -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
