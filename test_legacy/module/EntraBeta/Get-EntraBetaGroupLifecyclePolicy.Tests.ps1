...
BeforeAll {  
    ...
    Mock -CommandName Get-MgBetaGroupLifecyclePolicy -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta
}
...
Describe "Get-EntraBetaGroupLifecyclePolicy" {
    Context "Test for Get-EntraBetaGroupLifecyclePolicy" {
        It "Retrieve all groupLifecyclePolicies" {
            ...
            Should -Invoke -CommandName Get-MgBetaGroupLifecyclePolicy -ModuleName Microsoft.Graph.Entra.Beta -Times 1
        }
        ...
        It "Should fail when GroupLifecyclePolicyId is invalid" {
            { Get-EntraBetaGroupLifecyclePolicy -GroupLifecyclePolicyId "" } | Should -Throw "Cannot bind argument to parameter 'GroupLifecyclePolicyId' because it is an empty string."
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgBetaGroupLifecyclePolicy -ModuleName Microsoft.Graph.Entra.Beta -Times 1 -ParameterFilter {
