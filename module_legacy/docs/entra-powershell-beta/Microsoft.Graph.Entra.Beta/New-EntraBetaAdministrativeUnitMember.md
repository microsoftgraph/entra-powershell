...
For more information about the rules that you can use for dynamic groups, see [Using attributes to create advanced rules](/entra/identity/users/groups-dynamic-membership).
