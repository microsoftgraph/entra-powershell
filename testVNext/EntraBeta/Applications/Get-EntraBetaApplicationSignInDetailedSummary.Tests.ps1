...
BeforeAll {  
    ...
    Mock -CommandName Get-MgBetaReportApplicationSignInDetailedSummary -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta.Applications
}
...
Describe "Get-EntraBetaApplicationSignInDetailedSummary" {
    Context "Test for Get-EntraBetaApplicationSignInDetailedSummary" {
        It "Should return specific application signed in detailed summary by filter" {
            ...
            Should -Invoke -CommandName Get-MgBetaReportApplicationSignInDetailedSummary -ModuleName Microsoft.Graph.Entra.Beta.Applications -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgBetaReportApplicationSignInDetailedSummary -ModuleName Microsoft.Graph.Entra.Beta.Applications -Times 1 -ParameterFilter {
