...
BeforeAll {  
    ...
    Mock -CommandName New-MgBetaDirectoryFeatureRolloutPolicyApplyToByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
}
...
Describe "Add-EntraBetaFeatureRolloutPolicyDirectoryObject" {
    Context "Test for Add-EntraBetaFeatureRolloutPolicyDirectoryObject" {
        It "Should adds a group to the cloud authentication roll-out policy in Azure AD." {
            ...
            Should -Invoke -CommandName New-MgBetaDirectoryFeatureRolloutPolicyApplyToByRef -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain FeatureRolloutPolicyId in parameters when passed Id to it" {
            Mock -CommandName New-MgBetaDirectoryFeatureRolloutPolicyApplyToByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Add-EntraBetaFeatureRolloutPolicyDirectoryObject"
            Should -Invoke -CommandName New-MgBetaDirectoryFeatureRolloutPolicyApplyToByRef -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
