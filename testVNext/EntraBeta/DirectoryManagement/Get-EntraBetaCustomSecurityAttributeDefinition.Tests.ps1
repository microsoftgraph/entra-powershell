...
BeforeAll {  
    ...
    Mock -CommandName  Get-MgBetaDirectoryCustomSecurityAttributeDefinition -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
}
...
Describe "Get-EntraBetaCustomSecurityAttributeDefinition" {
    Context "Test for Get-EntraBetaCustomSecurityAttributeDefinition" {
        It "Should get custom security attribute definition by Id" {
            ...
            Should -Invoke -CommandName  Get-MgBetaDirectoryCustomSecurityAttributeDefinition -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraBetaCustomSecurityAttributeDefinition"
            Should -Invoke -CommandName Get-MgBetaDirectoryCustomSecurityAttributeDefinition -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
