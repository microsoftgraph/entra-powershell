...
BeforeAll {  
    ...
    Mock -CommandName New-MgBetaDeviceRegisteredUserByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
}
...
Describe "Add-EntraBetaDeviceRegisteredUser" {
    Context "Test for Add-EntraBetaDeviceRegisteredUser" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName New-MgBetaDeviceRegisteredUserByRef -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain DeviceId in parameters when passed DeviceId to it" {
            Mock -CommandName New-MgBetaDeviceRegisteredUserByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
        ...
        It "Should contain BodyParameter in parameters when passed RefObjectId to it" {
            ...
            Should -Invoke -CommandName New-MgBetaDeviceRegisteredUserByRef -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
