...
BeforeAll {  
    ...
    Mock -CommandName New-MgBetaDeviceRegisteredOwnerByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
}
...
Describe "Add-EntraBetaDeviceRegisteredOwner" {
    Context "Test for Add-EntraBetaDeviceRegisteredOwner" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName New-MgBetaDeviceRegisteredOwnerByRef -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain DeviceId in parameters when passed ObjectId to it" {
            Mock -CommandName New-MgBetaDeviceRegisteredOwnerByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
        ...
        It "Should contain BodyParameter in parameters when passed RefObjectId to it" {
            ...
            Add-EntraBetaDeviceRegisteredOwner -DeviceId "aaaaaaaa-0000-1111-2222-bbbbbbbbbbbb" -RefObjectId "bbbbbbbb-1111-2222-3333-cccccccccccc"
             $value = @{
                ...
                Should -Invoke -CommandName New-MgBetaDeviceRegisteredOwnerByRef -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
