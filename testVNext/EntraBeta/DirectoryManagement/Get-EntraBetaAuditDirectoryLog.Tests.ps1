...
BeforeAll {  
    ...
    Mock -CommandName Get-MgBetaAuditLogDirectoryAudit -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement
}
...
Describe "Get-EntraBetaAuditDirectoryLog" {
    Context "Test for Get-EntraBetaAuditDirectoryLog" {
        It "Should get all logs" {
            ...
            Should -Invoke -CommandName Get-MgBetaAuditLogDirectoryAudit -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -Not -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraBetaAuditDirectoryLog"
            Should -Invoke -CommandName Get-MgBetaAuditLogDirectoryAudit -ModuleName Microsoft.Graph.Entra.Beta.DirectoryManagement -Times 1 -ParameterFilter {
