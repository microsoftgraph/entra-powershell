...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgBetaUser -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.Users
}
...
Describe "Remove-EntraBetaUser" {
    Context "Test for Remove-EntraBetaUser" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgBetaUser -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1
        }
        ...
        It "Should contain UserId in parameters when passed UserId to it" {
            Mock -CommandName Remove-MgBetaUser -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.Users
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Remove-EntraBetaUser"
            Should -Invoke -CommandName Remove-MgBetaUser -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1 -ParameterFilter {
