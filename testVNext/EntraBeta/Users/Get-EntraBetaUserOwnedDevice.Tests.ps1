...
BeforeAll {  
    ...
    Mock -CommandName Get-MgBetaUserOwnedDevice -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Beta.Users
}
...
Describe "Get-EntraBetaUserOwnedDevice" {
    Context "Test for Get-EntraBetaUserOwnedDevice" {
        It "Should return specific user registered device" {
            ...
            Should -Invoke -CommandName Get-MgBetaUserOwnedDevice  -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraBetaUserOwnedDevice"
            Should -Invoke -CommandName Get-MgBetaUserOwnedDevice -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1 -ParameterFilter {
