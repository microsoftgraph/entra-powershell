...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgBetaUserManagerByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.Users
}
...
Describe "Remove-EntraBetaUserManager" {
    Context "Test for Remove-EntraBetaUserManager" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgBetaUserManagerByRef -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1
        }
        ...
        It "Should contain UserId in parameters when passed UserId to it" {
            Mock -CommandName Remove-MgBetaUserManagerByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.Users
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Remove-EntraBetaUserManager"
            Should -Invoke -CommandName Remove-MgBetaUserManagerByRef -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1 -ParameterFilter {
