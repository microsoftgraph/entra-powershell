...
BeforeAll {  
    ...
    Mock -CommandName Update-MgBetaUser -MockWith {} -ModuleName Microsoft.Graph.Entra.Beta.Users
}
...
Describe "Set-EntraBetaUser"{
    Context "Test for Set-EntraBetaUser" {
        It "Should return empty object"{
            ...
            Should -Invoke -CommandName Update-MgBetaUser -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1
        }
        ...
        It "Should contain UserId in parameters when passed ObjectId to it" {
            Mock -CommandName Update-MgBetaUser -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Beta.Users
        ...
        It "Should contain 'User-Agent' header" {
            ...
            $result | Should -BeNullOrEmpty
            $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Set-EntraBetaUser"
            Should -Invoke -CommandName Update-MgBetaUser  -ModuleName Microsoft.Graph.Entra.Beta.Users -Times 1 -ParameterFilter {
