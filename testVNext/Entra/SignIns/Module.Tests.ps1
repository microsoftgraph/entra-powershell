...
Describe "Microsoft.Graph.Entra.SignIns Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.SignIns
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.SignIns
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Graph.Entra.SignIns.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Graph.Entra.SignIns -ErrorAction SilentlyContinue").Invoke()
