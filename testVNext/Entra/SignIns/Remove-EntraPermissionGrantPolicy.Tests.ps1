...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgPolicyPermissionGrantPolicy -MockWith {} -ModuleName Microsoft.Graph.Entra.SignIns
}
...
Describe "Remove-EntraPermissionGrantPolicy" {
    Context "Test for Remove-EntraPermissionGrantPolicy" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgPolicyPermissionGrantPolicy -ModuleName Microsoft.Graph.Entra.SignIns -Times 1
        }
        ...
        It "Should contain PermissionGrantPolicyId in parameters when passed Id to it" {
            Mock -CommandName Remove-MgPolicyPermissionGrantPolicy -MockWith {$args} -ModuleName Microsoft.Graph.Entra.SignIns
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgPolicyPermissionGrantPolicy -ModuleName Microsoft.Graph.Entra.SignIns -Times 1 -ParameterFilter {
