...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgOAuth2PermissionGrant -MockWith {} -ModuleName Microsoft.Graph.Entra.SignIns
}
...
Describe "Remove-EntraGroupAppRoleAssignment" {
    Context "Test for Remove-EntraGroupAppRoleAssignment" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgOAuth2PermissionGrant -ModuleName Microsoft.Graph.Entra.SignIns -Times 1
        }
        ...
        It "Should contain OAuth2PermissionGrantId in parameters when passed ObjectId to it" { 
            Mock -CommandName Remove-MgOAuth2PermissionGrant -MockWith {$args} -ModuleName Microsoft.Graph.Entra.SignIns
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgOAuth2PermissionGrant -ModuleName Microsoft.Graph.Entra.SignIns -Times 1 -ParameterFilter {
