...
Describe "Get-EntraGroupOwner" {
    Context "Test for Get-EntraGroupOwner" {
        ...
        It "Should fail when GroupId is invalid" {
            { Get-EntraGroupOwner -GroupId "" } | Should -Throw "Cannot bind argument to parameter 'GroupId' because it is an empty string."
        }
        ...
        It "Should fail when top is empty" {
            { Get-EntraGroupOwner -GroupId "bbbbbbbb-1111-2222-3333-cccccccccccc" -Top } | Should -Throw "Missing an argument for parameter 'Top'*"
        }  
