...
Describe "Microsoft.Graph.Entra.Authentication Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Authentication
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Authentication
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Graph.Entra.Authentication.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Graph.Entra.Authentication -ErrorAction SilentlyContinue").Invoke()
