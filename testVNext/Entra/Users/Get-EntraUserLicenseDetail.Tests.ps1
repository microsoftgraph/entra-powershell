...
BeforeAll {
    ...
    Mock -CommandName Get-MgUserLicenseDetail -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Users
}
...
Describe "Get-EntraUserLicenseDetail" {
    Context "Test for Get-EntraUserLicenseDetail" {
        It "Should return specific User" {
            ...
            should -Invoke -CommandName Get-MgUserLicenseDetail -ModuleName Microsoft.Graph.Entra.Users -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgUserLicenseDetail -ModuleName Microsoft.Graph.Entra.Users -Times 1 -ParameterFilter {
