...
Describe "Remove-EntraDeviceRegisteredUser" {
    Context "Test for Remove-EntraDeviceRegisteredUser" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgDeviceRegisteredUserByRef -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1
        }
        ...
        It "Should contain DeviceId in parameters when passed UserId to it" {
            Mock -CommandName Remove-MgDeviceRegisteredUserByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.DirectoryManagement
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgDeviceRegisteredUserByRef -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1 -ParameterFilter {
