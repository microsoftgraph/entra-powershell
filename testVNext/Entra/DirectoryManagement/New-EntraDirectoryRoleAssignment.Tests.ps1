...
BeforeAll {  
    ...
    Mock -CommandName New-MgRoleManagementDirectoryRoleAssignment -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.DirectoryManagement
}
...
Context "Test for New-EntraDirectoryRoleAssignment" {
        It "Should return created Ms role assignment" {
            ...
            Should -Invoke -CommandName New-MgRoleManagementDirectoryRoleAssignment  -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName New-MgRoleManagementDirectoryRoleAssignment -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1 -ParameterFilter {
