...
BeforeAll {  
    ...
    Mock -CommandName Update-MgRoleManagementDirectoryRoleDefinition -MockWith {} -ModuleName Microsoft.Graph.Entra.DirectoryManagement
}
...
Describe "Set-EntraDirectoryRoleDefinition" {
    Context "Test for Set-EntraDirectoryRoleDefinition" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Update-MgRoleManagementDirectoryRoleDefinition -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1
        }
        ...
        It "Should contain UnifiedRoleDefinitionId in parameters when passed Id to it" {
            Mock -CommandName Update-MgRoleManagementDirectoryRoleDefinition -MockWith {$args} -ModuleName Microsoft.Graph.Entra.DirectoryManagement
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Update-MgRoleManagementDirectoryRoleDefinition -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1 -ParameterFilter {
