...
BeforeAll {  
    ...
    Mock -CommandName New-MgRoleManagementDirectoryRoleDefinition -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.DirectoryManagement
}
...
Describe "New-EntraDirectoryRoleDefinition" {
    Context "Test for New-EntraDirectoryRoleDefinition" {
        It "Should return specific Ms role Defination" {
            ...
            Should -Invoke -CommandName New-MgRoleManagementDirectoryRoleDefinition  -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName New-MgRoleManagementDirectoryRoleDefinition -ModuleName Microsoft.Graph.Entra.DirectoryManagement -Times 1 -ParameterFilter {
