...
BeforeAll {  
    ...
    Mock -CommandName Get-MgRoleManagementDirectoryRoleDefinition -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Governance
}
...
Describe "Get-EntraDirectoryRoleDefinition" {
    Context "Test for Get-EntraDirectoryRoleDefinition" {
        It "Should return specificrole Defination" {
            ...
            Should -Invoke -CommandName Get-MgRoleManagementDirectoryRoleDefinition  -ModuleName Microsoft.Graph.Entra.Governance -Times 1
        }
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Get-MgRoleManagementDirectoryRoleDefinition -ModuleName Microsoft.Graph.Entra.Governance -Times 1 -ParameterFilter {
