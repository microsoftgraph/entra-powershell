...
BeforeAll {  
    ...
    Mock -CommandName Get-MgServicePrincipalTransitiveMemberOf -MockWith $scriptblock -ModuleName Microsoft.Graph.Entra.Applications
}
Describe "Get-EntraServicePrincipalMembership"{
    It "Result should not be empty" {
        ...
        Should -Invoke -CommandName Get-MgServicePrincipalTransitiveMemberOf -ModuleName Microsoft.Graph.Entra.Applications -Times 1
    }
    ...
    It "Should contain 'User-Agent' header" {
        ...
        $result | Should -Not -BeNullOrEmpty
        $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Get-EntraServicePrincipalMembership"    
        Should -Invoke -CommandName Get-MgServicePrincipalTransitiveMemberOf -ModuleName Microsoft.Graph.Entra.Applications -Times 1 -ParameterFilter {
