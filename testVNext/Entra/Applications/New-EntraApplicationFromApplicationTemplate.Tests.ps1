...
BeforeAll{
    ...
    Mock -CommandName Invoke-MgGraphRequest -MockWith { $response } -ModuleName Microsoft.Graph.Entra.Applications.Applications
}
Describe "New-EntraApplicationFromApplicationTemplateFromApplicationTemplate tests"{
    It "Should return created Application with service principal"{
        ...
        Should -Invoke -CommandName Invoke-MgGraphRequest -ModuleName Microsoft.Graph.Entra.Applications.Applications -Times 1
    }
