...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgServicePrincipal -MockWith {} -ModuleName Microsoft.Graph.Entra.Applications
}
Describe "Remove-EntraServicePrincipal" {
    Context "Test for Remove-EntraServicePrincipal" {
        It "Should return empty object" {
            ...
            Should -Invoke -CommandName Remove-MgServicePrincipal -ModuleName Microsoft.Graph.Entra.Applications -Times 1
        }
        ...
        It "Should contain ServicePrincipalId in parameters when passed ServicePrincipalId to it" {
            Mock -CommandName Remove-MgServicePrincipal -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Applications
        ...
        It "Should contain 'User-Agent' header" {
            ...
            Should -Invoke -CommandName Remove-MgServicePrincipal -ModuleName Microsoft.Graph.Entra.Applications -Times 1 -ParameterFilter {
