...
BeforeAll {  
    ...
    Mock -CommandName Remove-MgApplicationOwnerByRef -MockWith {} -ModuleName Microsoft.Graph.Entra.Applications
}
...
Describe "Remove-EntraApplicationOwner"{
    It "Should return empty object" {
        ...
        Should -Invoke -CommandName Remove-MgApplicationOwnerByRef -ModuleName Microsoft.Graph.Entra.Applications -Times 1
    }
    It "Should return empty object" {
    ...
    It "Should contain ApplicationId in parameters" {
        Mock -CommandName Remove-MgApplicationOwnerByRef -MockWith {$args} -ModuleName Microsoft.Graph.Entra.Applications
        $result = Remove-EntraApplicationOwner -ApplicationId "aaaaaaaa-bbbb-cccc-1111-222222222222" -OwnerId "bbbbbbbb-cccc-dddd-2222-333333333333"
    ...
    It "Should contain 'User-Agent' header" {
        ...
        $result | Should  -BeNullOrEmpty
        $userAgentHeaderValue = "PowerShell/$psVersion EntraPowershell/$entraVersion Remove-EntraApplicationOwner"
        Should -Invoke -CommandName Remove-MgApplicationOwnerByRef -ModuleName Microsoft.Graph.Entra.Applications -Times 1 -ParameterFilter {
