...
Describe "Microsoft.Graph.Entra.Reports Module" {
    Context "On module import" {
        ...
        It "Should have exported commands" {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Reports
        ...
        It 'Should point to script module' {
            $PSModuleInfo = Get-Module Microsoft.Graph.Entra.Reports
            $PSModuleInfo.RootModule | Should -BeLikeExactly "*Microsoft.Graph.Entra.Reports.psm1"
        }
        ...
        It "Module import should not write to error and information streams" {
            ...
            $ps.AddScript("Import-Module Microsoft.Graph.Entra.Reports -ErrorAction SilentlyContinue").Invoke()
